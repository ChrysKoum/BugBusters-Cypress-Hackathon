...
describe("Select Country and Agree to Terms and Conditions", () => {
  ...
  it.only("ensures that a user can select their country and agree to the terms and conditions", () => {
    const homePage = new HomePage();
...
describe("Attempt to Proceed Without Agreeing to Terms & Conditions", () => {
  ...
  it.only("Attempt to Proceed Without Agreeing to Terms & Conditions", () => {
    const homePage = new HomePage();
    // Prerequisite: Go to the checkout page.
    homePage.Checkout();
    cy.get("button").contains("Place Order").click();
